...
public class Main {
    public static void main(String[] args) {
        ...
        int favoriteNumber = input.nextInt(); // Replace _ with the correct type and variable
        ...
        double decimalNumber = input.nextDouble(); // Replace _ with the correct type and variable
        ...
        char character = input.next().charAt(0); // Replace _ with the correct type and variable
        ...
        boolean likesPizza = input.nextBoolean(); // Replace _ with the correct type and variable
        ...
        // Close the scanner
        input.close(); // Replace _ with the correct scanner variable
    }
}